...
class Category(models.Model):
    ...
    parent: Union[str, int, list] = models.ForeignKey('self', null=True, blank=True, related_name='tags', on_delete=models.SET_NULL)
...
class Post(models.Model):
    ...
    description: str = models.TextField(null=True, blank=True, help_text="A brief description of the post optimized for SEO")
    content: str = models.TextField(default="Create a post.", help_text="The main content of the post")
    slug: str = models.SlugField(unique=True, blank=True, help_text="A unique slug for the post")
